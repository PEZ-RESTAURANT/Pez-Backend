...
/**
 * Evento de dominio emitido al conceder un override explícito de permiso (GRANTED) a un usuario.
 * <p>
...
public record PermissionGrantedEvent(
     ...
     */
    public PermissionGrantedEvent(String userId, String targetUserId, String permissionCode, String reason) {
